...
**Download (macOS Apple Silicon):** [obs-airplay-0.2.2-macos-arm64.pkg](https://github.com/dgraid/obs-airplay-plugin/releases/latest/download/obs-airplay-0.2.2-macos-arm64.pkg)
...
```bash
./scripts/package_pkg.sh   # → dist/obs-airplay-0.2.2-macos-arm64.pkg
./scripts/install.sh
```
