...
| 2026-08-23 | Receiver name is **module** config (Tools), not per-source | One Bonjour name. Cocoa dialog, no Qt. JSON keeps empty `on_connect_scene` / `on_disconnect_scene` for later automations. |
