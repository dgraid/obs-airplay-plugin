...
| 2026-08-23 | iOS lock ≠ lock screen; Paused shows the idle stub | AirPlay mirroring does not send lock-screen pixels. `video_pause` → stub, keep session. `video_resume` + IDR → live. Last frozen app frame is a privacy leak and a resume bug. |
