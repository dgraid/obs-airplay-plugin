...
| 22 | Letterbox morph wide↔narrow | **BLOCKED** | Same 300ms. Needs owner: connect shrinks 16:9 stub into the phone rect; disconnect expands; rotate morphs; **margins transparent** (color source behind shows through). |
