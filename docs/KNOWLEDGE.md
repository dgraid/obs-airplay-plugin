...
- Source size = OBS canvas always. Live frames contain-scaled with black bars. Idle/Paused = instruction stub, never a frozen last frame.
...
|---|---|---|
| `0x56` / `0x5e` | sleep / stream stop | `video_pause` → IPC Paused → stub |
